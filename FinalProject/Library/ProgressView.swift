...
class ProgressView: UIView {
    ...
    public var imgLogo: UIImage = UIImage(named:"people")!
    ...
    public var secondColor: UIColor? = UIColor.red
    public var thirdColor: UIColor? = UIColor.yellow
